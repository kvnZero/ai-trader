...
class PortfolioRiskOverviewWorkspaceTests(TestCase):
    def test_recommendations_workspace_includes_portfolio_risk_overview(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            database = init_database(str(Path(tmpdir) / "portfolio-risk-view.db"))
            ...
            cash_repository.upsert_balance(balance=80000.0)
