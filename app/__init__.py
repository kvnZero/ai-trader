...
from app.persistence import MarketEventRepository, PortfolioSettingsRepository, RecommendationSnapshotRepository, SentimentRepository
...
def create_app() -> Flask:
    ...
    app.config["TRADER_MARKET_EVENT_REPOSITORY"] = MarketEventRepository(runtime.watchlist_repository.database)
